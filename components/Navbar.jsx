...
const Navbar = () => {
  ...
  return (
    <nav className="px-6 md:px-16 lg:px-32 py-1.5 border-b border-gray-300 dark:border-gray-700 text-gray-700 dark:text-white bg-white dark:bg-black transition-all duration-300 flex md:grid md:grid-cols-[auto_1fr_auto] items-center justify-between md:gap-4">
      {/* Logo */}
      <Image
