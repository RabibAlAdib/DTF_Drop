...
const ProductCard = ({ product }) => {
    ...
    return (
        ...
        >
            <div className="cursor-pointer group relative bg-gray-500/10 rounded-lg w-full h-48 md:h-56 flex items-center justify-center overflow-hidden">
                <Image
                    src={product.images[0]}
                    alt={product.name}
                    className="group-hover:scale-102 transition-all duration-300 object-contain w-full h-full rounded-lg"
                    width={800}
                    height={800}
                />
                <button 
