  ...
  getAvailablePaymentMethods() {
    ...
    return {
      ...
      bkash: {
        ...
        description: config.bkash.configured ? 'Pay with bKash mobile wallet' : 'Configuration Required',
        configured: config.bkash.configured
      },
      nagad: {
        name: 'Nagad',
        enabled: config.nagad.configured && config.nagad.enabled,
        description: config.nagad.configured ? 'Pay with Nagad mobile wallet' : 'Configuration Required',
