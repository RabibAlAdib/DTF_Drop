...
export const sendSellerNotificationEmail = async (orderData, sellerEmail) => {
  try {
    ...
    const deliveryCharge = orderData.pricing.deliveryFee || orderData.delivery.fee || 0;
    const discountAmount = orderData.pricing.discount || 0;
    ...
    const templateVariables = {
      ...
      sellerDashboardUrl: process.env.NEXT_PUBLIC_APP_URL || 'https://dtfdrop.com'
    };
