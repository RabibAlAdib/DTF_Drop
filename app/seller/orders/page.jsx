...
const Orders = () => {
    ...
    const updateOrderStatus = async (orderId, newStatus) => {
        try {
            ...
            const { data } = await axios.put('/api/orders/seller', {
                orderId,
                status: newStatus
            }, {
                headers: { Authorization: `Bearer ${token}` }
            ...
            <div className="md:p-10 p-4 space-y-5">
                ...
                {orders.length === 0 ? (
                    <div className="text-center py-10 text-gray-500">
                        <Image src={assets.box_icon} alt="No orders" className="mx-auto mb-4 opacity-50" width={64} height={64} />
                        <p>No orders found</p>
                    </div>
                ) : (
                            ...
                            <div key={order._id || index} className="border rounded-lg p-6 bg-white shadow-sm">
                                ...
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 pb-4 border-b">
                                    ...
                                    <div className="flex items-center gap-3 mt-2 md:mt-0">
                                        ...
                                        <span className="font-semibold text-lg text-green-600">
                                            {currency}{order.pricing.sellerTotal || order.pricing.totalAmount}
                                        </span>
                                    </div>
                                </div>
                                            ...
                                            <div key={itemIndex} className="flex items-center gap-4 p-3 bg-gray-50 rounded">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="text-sm text-gray-600 space-x-4">
                                                        ...
                                                        <span>Price: <strong>{currency}{item.unitPrice}</strong></span>
                                                    </div>
                                ...
                                <div className="grid md:grid-cols-3 gap-6 mt-4 pt-4 border-t">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <p><strong>Fee:</strong> {currency}{order.delivery.fee}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <p><strong>Total:</strong> <span className="font-semibold">{currency}{order.pricing.totalAmount || (order.pricing.subtotal + (order.pricing.deliveryCharge || order.pricing.deliveryFee) - (order.pricing.discountAmount || 0))}</span></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {order.giftInfo && order.giftInfo.isGift && (
                                    <div className="mt-4 pt-4 border-t">
                                        <h4 className="font-medium mb-2">🎁 Gift Information</h4>
                                        <div className="text-sm space-y-1 bg-pink-50 p-3 rounded">
                                            <p><strong>Gift Message:</strong> {order.giftInfo.message}</p>
                                            <p><strong>Recipient:</strong> {order.giftInfo.recipientName}</p>
                                        </div>
                                    </div>
                                )}
                            </div>
