              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Choose Product</h3>
                  </div>
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            <p className="text-sm font-bold text-green-600">From ৳{Math.min(...template.availableSizes.map(s => s.price))}</p>
                          </div>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {selectedTemplate.availableColors.map((color) => (
                        ...
                        >
                          <div
                            className="w-full h-10 rounded-md mb-2 border border-gray-200 shadow-sm"
                  ...
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {selectedTemplate.availableSizes.map((sizeInfo) => (
                        ...
                        >
                          <p className="font-semibold text-gray-900 text-center text-lg">{sizeInfo.size}</p>
                          <p className="text-sm text-green-600 text-center font-medium">৳{sizeInfo.price}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Upload Designs</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                        ...
                        >
                          {uploadingArea === 'front' ? (
                            ...
                            <div className="flex items-center gap-2 text-green-600">
                              ...
                              <span className="text-sm font-medium">Front design uploaded</span>
                            </div>
                          ) : (
                            <div className="text-center">
                              ...
                              <p className="text-sm text-gray-500 mt-1">Upload Front Design</p>
                            </div>
                          )}
                        </label>
                      </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Pocket Design <span className="text-gray-500">(+৳{selectedTemplate?.extraImagePrice || 30})</span>
                      </label>
                      <div className="relative">
                        <input
                          type="file"
                        ...
                        >
                          {uploadingArea === 'pocket' ? (
                            ...
                            <div className="flex items-center gap-2 text-green-600">
                              ...
                              <span className="text-sm font-medium">Pocket design uploaded</span>
                            </div>
                          ) : (
                            <div className="text-center">
                              <svg className="mx-auto h-8 w-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              <p className="text-sm text-gray-500 mt-1">Upload Pocket Design</p>
                            </div>
                          )}
                        </label>
                      </div>
                ...
                {selectedDesign && userDesigns[selectedDesign].imageUrl && (
                  <div className="bg-blue-50 rounded-xl p-5 border border-blue-100">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          {selectedDesign.charAt(0).toUpperCase() + selectedDesign.slice(1)} Design Size
                        </label>
                      ...
                      <div className="text-xs text-gray-500 bg-white p-3 rounded-lg">
                        ...
                        <p>Use arrow keys to fine-tune position. Hold Shift for bigger steps!</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="bg-green-50 rounded-xl p-5 border border-green-100">
                  ...
                  <div className="space-y-3">
                    ...
                    {userDesigns.sleeve.imageUrl && (
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Sleeve Design:</span>
                        <span className="font-medium">৳{selectedTemplate?.extraImagePrice || 30}</span>
                      </div>
                    )}
                    {userDesigns.pocket.imageUrl && (
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Pocket Design:</span>
                        <span className="font-medium">৳{selectedTemplate?.extraImagePrice || 30}</span>
                      </div>
                    )}
                  ...
                  <button
                    ...
                    className="w-full mt-4 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg"
                  >
                    Add to Cart
                  </button>
                </div>
