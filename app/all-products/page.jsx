...
const AllProducts = () => {
    ...
    const categories = useMemo(() => {
        ...
        return [
            "ALL",
            ...requiredCategories.filter((cat) => existingCategories.has(cat)),
        ];
    }, [products]);
    ...
    const filteredProducts = useMemo(() => {
        return products.filter((product) => {
            ...
            const designTypeMatch =
                ...
                product.designType === activeDesignType;
        ...
        <>
            <div className="bg-gradient-to-br from-white via-gray-50 to-white dark:from-black dark:via-gray-900 dark:to-black min-h-screen">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-6 md:px-16 lg:px-32 mt-6 mb-6 gap-4">
                    ...
                    <div className="flex-1">
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            {activeDesignType !== "ALL" &&
                                ` with design type "${activeDesignType}"`}
                        </p>
                    </div>
                ...
                <div className="px-6 md:px-16 lg:px-32">
                    {/* Products Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-6 gap-6 pb-14 items-stretch">
                            ...
                            <div className="text-gray-500 dark:text-gray-400 text-center">
                                ...
                                >
                                    <path
                                        ...
                                        strokeWidth={1.5}
                                        d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-5.5a2.5 2.5 0 00-2.5 2.5v0a2.5 2.5 0 01-2.5 2.5H12"
                                    />
                                </svg>
